...
<div style='text-align: center; background: linear-gradient(135deg, #004e92 0%, #000428 100%); padding: 20px; border-radius: 10px; color: white; margin-bottom: 20px;'>
    ...
    <p style='margin-top:10px;'>Tác giả: Thầy Hoàng Minh Tiến - PTDTBT TH Du Tiến </p>
</div>
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Minh Tiến - Trường PTDTBT Tiểu học Du Tiến - ĐT: 0964 973 866 </div>", unsafe_allow_html=True)
